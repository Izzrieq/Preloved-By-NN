...
$queryTshirts = "SELECT * FROM products WHERE category_id IN (1,2,3) ORDER BY order_count DESC LIMIT 6";
    ...
    <script>
        ...
        function handleAddToCart(productId) {
            if (!isLoggedIn) {
                ...
                fetch(`functions/getVariantBySize.php?productId=${productId}&size=60ml`)
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            alert('Failed to get 60ml variant.');
                        }
                    })
                    .catch(error => {
                        console.error('Error:', error);
                        alert('An error occurred while fetching product variant.');
                    });
            }
        }
